...
![逻辑视角](http://47.111.9.220/第三次图片/体系结构第三阶段v1.0/逻辑视角.png)

![逻辑设计方案](http://47.111.9.220/第三次图片/体系结构第三阶段v1.0/逻辑设计方案.png)
...
![开发包图](http://47.111.9.220/第三次图片/体系结构第三阶段v1.0/开发包图.png)

### 4.2运行时进程

在电子影院管理系统中，会有多个客户端进程和一个服务器端进程，其进程图如图5所示。结合部署图，客户端进程是在客户机浏览器上运行，服务器端进程在服务器端机器上运行。

![进程图](http://47.111.9.220/第三次图片/体系结构第三阶段v1.0/进程图.png)
...
![部署图](http://47.111.9.220/第三次图片/体系结构第三阶段v1.0/部署图.png)
...
![模块职责](http://47.111.9.220/第三次图片/体系结构第三阶段v1.0/模块职责.png)
...
![界面图](http://47.111.9.220/第三次图片/体系结构第三阶段v1.0/界面图.png)

##### 5.2.1.1类图

![用户界面类](http://47.111.9.220/第三次图片/体系结构第三阶段v1.0/用户界面类.png)
